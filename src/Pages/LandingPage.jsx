  ...
  return (
    <>
      <main>
        ...
        />
        <Nominee />
        <Blog img1={appdev} img2={openai} img3={fitness} heading1={"How Does MyFitnessPal Work As Canada’s Most Popular Fitness App?"} para1={"“The sweat is the footprints towards a better you!” This random quote on workout is likely to motivate."} heading2={"What Is ChatGPT & How Does It Work? Is There Any Practical Use Of ChatGPT?"} para2={"Imagine a personal assistant who never takes leaves, is always available to serve you, and has instant."} heading3={"How is IoMT Revolutionizing the Healthcare Industry?"} para3={"Amongst the technological disruption in several vital industries, Healthcare is the one that has the."}/>
        <PortfolioSection
          img={dyna}
          bgClass={"bg-dyna"}
          heading={"Dyna-Glo"}
